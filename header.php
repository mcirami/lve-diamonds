...
<div class="page_wrap">
	<header class="global_header">
		<div class="container-960">
			<div class="logo"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" alt="LVE Diamonds" rel="home"><img src="<?php bloginfo('template_url'); ?>/images/logo.png" alt="Discover LVE" /></a>
		...
		<div class="mobile-header show-on-mobile">
			<div class="logo">
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
					...
					<?php else : ?>
						<img src="<?php bloginfo('template_url'); ?>/images/logo.png" alt="Discover LVE" />
					<?php endif; ?>
				</a>
			</div>
