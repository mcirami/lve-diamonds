     ...
     * ====================================================================== */     
        ...
        filterContainer.find(settings.filter).on('click', function(){
            ...
            if($(this).hasClass('all')) {
				$('.media-boxes-filter li a').removeClass('selected');
				$(this).addClass('selected');
			} else {
				if($(this).hasClass('selected')) {
					$(this).removeClass('selected');
					if(!$('.media-boxes-filter li a').hasClass('selected')) {
						$('.media-boxes-filter li a.all').addClass('selected');
					}
				} else {
					$(this).parent().parent().find('li a').removeClass('selected');
					$('.media-boxes-filter li a.all').removeClass('selected');
					$(this).addClass('selected');
				}
			}
            
            var filterValue = '';
			$('.media-boxes-filter li a').each(function(e) {
				if($(this).hasClass('selected')) {
