...
<section class="filtering">
	...
	<div class="container">
		...
		<ul class="media-boxes-filter" id="filter">
		  ...
		  <?php endif; ?>
		  <?php if (get_terms('occasion')) : ?>
		  <li class="filter-group"><p>Occasoin <i class="fa fa-angle-right"></i></p>
			  <ul class="sub-filters">
				  <?php foreach($occasions as $occasionTerm) : ?>
				  	<li><a href="#" data-filter=".<?php echo $occasionTerm->slug; ?>"><?php echo $occasionTerm->name; ?></a></li>
				  <?php endforeach; ?>
			  </ul>
		  </li>
		  <?php endif; ?>
		  <?php if (false) : // temporarily disabled price by setting it to false ?>
