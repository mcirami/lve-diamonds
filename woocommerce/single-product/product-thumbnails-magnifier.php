        ...
        <?php if (get_field('product_video')) : ?>
			<div class="video_thumbnail">
				<a class="fancybox" href="#inline">
					<?php if (get_field('product_video_thumb')) : ?>
					<?php $productThumb = get_field('product_video_thumb'); ?>
						<img src="<?php echo $productThumb['sizes']['download']; ?>" />
					<?php else : ?>
						<img src="<?php bloginfo('template_url'); ?>/images/fpo.png" />
					<?php endif; ?>
				</a>
			</div>
			<div id="inline" class="fancybox_video">
				<?php echo apply_filters('the_content', get_field('product_video')); ?>
			</div>
		<?php endif; ?>
